...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest(){
        ...
        val savedUser = userRepository.save(User("강성운", null))
        val request = BookLoanRequest("강성운", "이상한 나라의 엘리스")
    ...
    @Test
    @DisplayName("책이 이미 대출 중이면, 신규 대출 실패")
    ...
    fun returnBookTest() {
        ...
        val savedUser = userRepository.save(User("강성운", null))
        userLoanHistoryRepository.save(UserLoanHistory(savedUser,"이상한 나라의 엘리스", false))
        val request = BookReturnRequest("강성운", "이상한 나라의 엘리스")
